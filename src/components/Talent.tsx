        ...
        <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-2">
          <div className="lg:col-span-2 xl:col-auto">
            <div className="flex flex-col justify-start w-full h-full bg-orange-100 px-14 rounded-2xl py-14 dark:bg-trueGray-800">
              ...
              <p className="text-2xl leading-normal ">
                Afiliasi Fakultas Kedokteran UNS, Prodi S2 Ilmu Gizi Sekolah
                Pascasarjana UNS, Prodi S3 Ilmu Kesehatan Masyarakat UNS, dan
                Pusat Penelitian & Pengembangan Pangan Gizi dan Kesehatan
                Masyarakat, LPPM, UNS
              </p>
            </div>
          </div>
          <div className="lg:col-span-2 xl:col-auto">
            <div className="flex flex-col justify-start w-full h-full bg-orange-100 px-14 rounded-2xl py-14 dark:bg-trueGray-800">
              ...
              />
              <p className="text-2xl leading-normal ">
                Diet seimbang dengan cara baik dan benar menjadi salah satu cara
                untuk memulai hidup srhat & bahagia
              </p>
            </div>
          </div>
        </div>
