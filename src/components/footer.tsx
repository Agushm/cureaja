...
export default function Footer() {
  ...
  return (
    <div className="relative bg-orange-500">
      <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 dark:border-trueGray-700 lg:grid-cols-5">
        <div className="lg:col-span-2">
          ...
          Perumahan Griya Permata Asri blok A 13 Klegen, Malangjiwan, Jawa, Kec. Colomadu, Kabupaten Karanganyar, Jawa Tengah
          </div>
        </div>
      ...
      <div className="mt-5 w-1/2 mx-auto border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5"/>
      <div className=" text-sm text-center text-white p-5">
        Copyright © {new Date().getFullYear()}. Made with ♥ by{" "}
        <a href="https://cureaja.id/" target="_blank" rel="noopener">
          CureAja.
        </a>{" "}
      </div>
    </div>
